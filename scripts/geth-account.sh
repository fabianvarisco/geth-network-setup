...
mkdir_preserve_user "$REAL_GETH_INSTANCE/$NODE"
...
new )
    ...
    sudo rm -f "$REAL_GETH_INSTANCE/$KEYSTORE_PASSWORD_FILENAME"
    echo "$KEYSTORE_PASSWORD" | sudo tee "$REAL_GETH_INSTANCE/$KEYSTORE_PASSWORD_FILENAME"
